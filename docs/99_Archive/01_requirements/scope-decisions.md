...
- Existing roadmap/workflow planning in `docs/PLAN_workflow-preset-variant.md` supports a first-class workflow/preset abstraction inside the same application.
