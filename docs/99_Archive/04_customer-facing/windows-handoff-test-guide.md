...
`Continue from docs/04_customer-facing/windows-handoff-test-guide.md and help me run the Windows validation.`
...
`Continue from docs/04_customer-facing/windows-handoff-test-guide.md. Help me validate the Andent MVP on this Windows machine, starting with PreFormServer health check and app launch.`
