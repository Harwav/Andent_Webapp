...
- Source plan: `docs/02_planning/prd-andent-v2-unattended-dispatch.md`
- Source evidence: `docs/02_planning/verification_test_data_2_build_quality_20260410/verification-summary.json`
